...
export function CartModal({ open }: { open: boolean }) {
  ...
  return (
    <dialog
      ref={modalRef}
      className="fixed top-20 w-[95%] overflow-hidden rounded-xl bg-white text-start shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] outline-none open:animate-fade open:animate-duration-300 md:absolute md:right-0 md:top-12 md:m-0 md:w-96 md:-translate-x-[70%]"
    >
